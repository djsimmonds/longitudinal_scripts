...
## paths
paths<-list()
paths$study<-"/home/danisimmonds/Dani/dti_0811/tbss"
paths$data<-"/Volumes/Connor/DTI_STUDY/tbss0711/stats"
...
mask<-nifti.image.read(paste(paths$data,"mean_FA_skeleton_mask_2mm_bin.nii.gz",sep="/"))
d<-mask$dim
c<-mask$qto.xyz
...
save(vox,file=paste(paths$data,"vox.Rframe",sep="/"))
